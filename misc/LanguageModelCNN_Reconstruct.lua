...
local layer, parent = torch.class('nn.LanguageModelCNN_Reconstruct', 'nn.Module')
...
function layer:forward(input)
    ...
    self.lstm_inputs = {}
    table.insert(self.lstm_inputs, imgs) -- First one is the img.
